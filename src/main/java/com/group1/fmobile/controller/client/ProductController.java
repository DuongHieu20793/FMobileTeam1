...
//            return "redirect:/checkout-not-login?productId%5B%5D=" + productId + "&productQuantity%5B%5D=1&totalAmount=" + product.getPrice();
//        } else {
...
//    }
    ...
    public String checkout(@RequestParam Long productId, Model model, Principal principal) {
        ...
        // Chuyển hướng đến phương thức mới trong GuestCheckOutController
        return "redirect:/checkout/single-product?productId=" + productId;
    }
}
