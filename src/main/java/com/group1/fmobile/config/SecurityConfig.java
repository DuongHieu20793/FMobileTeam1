...
//                        .requestMatchers("/", "/login", "/register",  "/css/**", "/js/**", "/images/**", "/verify", "/reset-password", "/forgotpassword","/home","/guest/**", "/checkout/**","/checkout-not-login","/client/homepage","/resend-otp").permitAll()
