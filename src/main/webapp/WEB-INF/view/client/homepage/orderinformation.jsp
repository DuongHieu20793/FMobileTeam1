...
<%--&lt;%&ndash;                                        <p class="text-muted mb-0"><span class="fw-bold me-4">Discount</span>${order.discount}</p>&ndash;%&gt;--%>
<%--                                    </div>--%>
                ...
                <li class="nav-item">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                        ...
                        <path fill-rule="evenodd"
                              ...
                              clip-rule="evenodd" />
                    </svg><a class="nav-link menu" href="#">Mobile</a>
                </li>
                <li class="nav-item">
                    <i class="fas fa-laptop"></i>
                    <a class="nav-link menu" href="#">Laptop</a>
...
top: 60%;" class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none"
        ...
        <div class="form-check form-switch dark-mode-toggle mx-5">
            <input class="form-check-input" type="checkbox" id="darkModeToggle" /><label class="form-check-label" style="width: 60px;font-size: 1.2rem" for="darkModeToggle">Dark Mode</label>
        </div>
    </div>
</nav>
<%--Main--%>
                    ...
                    <div class="col-lg-12 col-xl-10">
                        <div class="card" style="border-radius: 10px;">
                                ...
                                <div class="card shadow-0 border mb-4">
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 text-center d-flex justify-content-center align-items-center"><p class="text-muted mb-0 small" style="font-size: 2rem">ram: ${orderDetails.product.ram}</p>
                                            </div>
                                            <div class="col-md-2 text-center d-flex justify-content-center align-items-center">
                                                <p class="text-muted mb-0 small" style="font-size: 2rem">qty: ${orderDetails.quantity}</p>
                                            </div>
                            ...
                            <div class="card-footer border-0 px-4 py-5"
                                 ...
                                 style="background-color: #0d6efd; border-bottom-left-radius: 10px; border-bottom-right-radius: 10px;">
                                <div class="d-flex align-content-center justify-content-between text-white text-uppercase mb-0">
                                    <a href="${pageContext.request.contextPath}/client/productsDetail/${order.id}" class="btn mt-1 button_return" style="color: #FFFFFF; font-size: 1.7rem"><i class="fa-solid fa-cart-shopping mx-2"></i>Buy Back</a><h5 class="mt-3">Total paid: <span class="">$${order.totalPayment}</span></h5>
                                </div>
                            </div>
                        </div>
                    </div>
