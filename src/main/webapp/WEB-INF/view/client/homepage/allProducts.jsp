...
<div class="container">
    <div class="row">
        <div class="categories" style="margin-top: 85px">
            <a style="font-size:x-large;" class="category" href="#">All Products (${allProducts.size()})</a>
            <h2 class="mt-3 mb-3">Kết quả tìm kiếm cho: "${searchQuery}"</h2>
        </div>
        <div class="col-3">
            <div class="filter-container">
        ...
        <c:choose>
            ...
            <c:otherwise>
                ...
                <c:forEach items="${allProducts}" var="product">
                    ...
                    <div data-id="${product.id}" class="item" style="height: 500px">
                        <div class="row" style="width: 100%; height: 300px; overflow: hidden;">
                            <!-- Liên kết hình ảnh đến trang chi tiết sản phẩm -->

                            <a class="col-7"
                               href="${pageContext.request.contextPath}/client/productsDetail/${product.id}">
                                <img style="width: 100%; height: 100%; object-fit: cover; margin-right: 7px"
                                     src="${product.images[0].url}" alt="${product.productName}">
                            </a>
                            <div class="item-info col-5"><h2>${product.productName}</h2>
                                <div class="price">$${product.price}</div>
                                <div class="detail">
                                    <p>Brand: ${product.brand.brandName}</p>
                                    <p>RAM: ${product.ram}</p>
